...
(1 vai) đều đã `done`, và Epic 3 có đường đi rõ ràng không cần nguồn mới. Epic 1b và Epic 2b (5
vai) hiện đang chờ một nguồn rulebook mới — không tự tin
...
3. Tiếp theo: Epic 3 (Dire Wolf, Lone Wolf, Wolf Man, Wolf Cub — 4 vai Sói mới, không phụ thuộc
   nghiên cứu thêm) là epic tiếp theo không bị chặn theo đúng thứ tự ưu tiên đã nêu ở trên. Song
   song hoặc xen kẽ, có thể thử tìm lại rulebook gốc để gỡ chặn Epic 1b/2b (5 vai) nếu có thời
   gian, nhưng Epic 3 không cần chờ việc đó.
4. Trước khi viết story cho từng vai trong Epic 3, áp dụng đúng bài học lặp lại từ Epic 1b/2b:
   soi kỹ paraphrase từng vai riêng lẻ để phát hiện mơ hồ thời điểm/trạng thái/điều kiện thắng
   trước khi coi cả epic là "story ready" — đừng giả định cả 4 vai đều rõ chỉ vì tên+khái niệm đã
   xác nhận.
5. Cập nhật bảng theo dõi tiến độ ở trên mỗi khi một vai đổi trạng thái.
