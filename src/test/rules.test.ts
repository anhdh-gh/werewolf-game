...
const EXISTING_ROOM = {
  ...
  settings: {
    maxPlayers: 8,
    rolesEnabled: { BODYGUARD: true, TRAITOR: true, HUNTER: true, CUPID: true, MUTER: true, CURSED: true, LYCAN: true, MASON: true, PRINCE: true, PACIFIST: true, SORCERER: true, TANNER: true },
    remoteMode: false,
  },
  members: {
